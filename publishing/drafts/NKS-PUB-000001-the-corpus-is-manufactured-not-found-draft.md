...
A chat history is not a corpus.

An archive is not architecture.

Those things may contain value, but they do not automatically become usable knowledge. They are source material. They are raw inputs. They are evidence that something happened, something was written, something was discussed, or something was preserved.
...
They have created an archive.

A corpus is something different.
...
A LinkedIn post is no longer a disconnected thought. It is a derivative of a larger framework.
