...
def model_use_path_manifest() -> OperationPathManifest:
    ...
    return OperationPathManifest(
        ...
        paths=[
            ...
            _path("unknown-confidence-defer"),
            _path("low-confidence-defer"),
            _path("moderate-confidence-include", state_changing=True),
            _path("high-confidence-include", state_changing=True),
            ...
            _path("duplicate-item-id", terminal=rollback),
            _path("duplicate-directive-id", terminal=rollback),
