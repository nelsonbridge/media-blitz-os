    ...
    def retrieve(
        ...
        *,
        ...
        if request.view == HostedRetrievalView.CURRENT_AUTHORITY:
            retrieval_view = RetrievalView.CURRENT
            effective_at = request.effective_at
            authority_at = request.authority_at
        elif request.view == HostedRetrievalView.HISTORICAL:
            retrieval_view = RetrievalView.HISTORICAL
            effective_at = request.effective_at
            authority_at = request.authority_at
        else:
            retrieval_view = RetrievalView.CURRENT
        ...
        assert effective_at is not None and authority_at is not None
