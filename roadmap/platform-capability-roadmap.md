...
If a proposed action increases output volume but does not improve capability, coherence, proof, reuse, learning, or strategic optionality, it is not a V2 priority.

## Status

Implemented as V2 roadmap foundation.